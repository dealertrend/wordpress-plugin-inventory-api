<?php
	...
	if ( empty($year_filter) ) {
		...
		$model_data = $vehicle_reference_system->get_models()->please( array( 'make' => $make , 'year' => $current_year ) );
		$model_data = isset( $model_data[ 'body' ] ) ?json_decode( $model_data[ 'body' ] ) : NULL;
	}
