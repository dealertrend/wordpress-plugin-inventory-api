<?php
	...
	$inventory_link_new = isset($rules['^(inventory)']) ? '/inventory/New/' : '?taxonomy=inventory&saleclass=New';
	$inventory_link_used = isset($rules['^(inventory)']) ? '/inventory/Used/' : '?taxonomy=inventory&saleclass=Used';
...
?>
	<div id="help">
		...
		<p>For further assistance click the link below:<br><br> <a href="http://cardealerpress.com/academy/inventory-plugin-tutorials/permalink-menu-setup-for-inventory/" title="CarDealer Press Help Link" > http://cardealerpress.com/academy/inventory-plugin-tutorials/permalink-menu-setup-for-inventory/</a> </p>
		...
		<p>If the VMS and Company Feed are both loaded, you may view your inventory here:<br>
			<a href="<?php bloginfo( 'url' ); echo $inventory_link_new; ?>" target="_blank"><?php bloginfo( 'url' ); echo $inventory_link_new; ?></a><br>
			<a href="<?php bloginfo( 'url' ); echo $inventory_link_used; ?>" target="_blank"><?php bloginfo( 'url' ); echo $inventory_link_used; ?></a>
		</p>
