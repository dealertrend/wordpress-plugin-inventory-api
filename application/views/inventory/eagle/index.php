<?php
	...
	wp_enqueue_script(
		'dealertrend-inventory-theme-eagle',
		$this->plugin_information[ 'PluginURL' ] . '/application/views/inventory/eagle/js/eagle.js',
	...
	if ( empty( $remove_responsive ) ) {
		wp_enqueue_style(
			'dealertrend-eagle-responsive' ,
			$this->plugin_information[ 'PluginURL' ] . '/application/views/inventory/eagle/css/eagle-responsive.css' ,
			false ,
			'1.0'
		);
	}
	...
	if ( !isset($setprintpage) ) {
		...
		wp_enqueue_style(
			...
			$this->plugin_information[ 'PluginURL' ] . '/application/views/inventory/eagle/css/dealertrend-inventory-print.css' ,
			false ,
			'0.5'
		);
	}
