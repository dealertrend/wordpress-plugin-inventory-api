...
namespace Wordpress\Plugins\Dealertrend\Inventory\Api;
	...
	function get_detail_column( $style, $vehicle, $price, $fuel, $tags, $detail_tabs, $equipment ){
		...
		$column .= '<div id="vehicle-info-wrapper">' . ( !empty($vehicle['exterior_color']) ?'<div id="info-ext-color"><span>Exterior: </span>'.$vehicle['exterior_color'].'</div>':'' ) . ( !empty($vehicle['interior_color']) ?'<div id="info-int-color"><span>Interior: </span>'.$vehicle['interior_color'].'</div>':'' ) . ( !empty($vehicle['engine']) ?'<div id="info-engine"><span>Engine: </span>'.$vehicle['engine'].'</div>':'' ) . ( !empty($vehicle['transmission']) ?'<div id="info-transmission"><span>Transmission: </span>'.$vehicle['transmission'].'</div>':'' ) . ( !empty($vehicle['odomter']) ?'<div id="info-odometer"><span>Odometer: </span>'.$vehicle['odometer'].'</div>':'' ) . ( !empty($vehicle['stock_number']) ?'<div id="info-stock-number"><span>Stock #: </span>'.$vehicle['stock_number'].'</div>':'' ) . ( !empty($vehicle['vin']) ?'<div id="info-vin"><span>VIN: </span>'.$vehicle['vin'].'</div>':'' ).'</div>';
