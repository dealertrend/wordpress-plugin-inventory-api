			...
			<div id="armadillo-list-sidebar">
					...
					<li class="armadillo-expanded">
						...
						<ul>
							<?php switch( $inventory_options['saleclass_filter'] ) {
								case 'all':
									echo '<li><span class="no-style"><a href="' . $new_link . '" title="View New Inventory" class="list-button ' . (strtolower( $param_saleclass ) == 'new' ? 'disabled' : NULL) . '">New</a></span></li>';
									echo '<li><span class="no-style"><a href="' . $used_link . '" title="View Used Inventory" class="list-button ' . (strtolower( $param_saleclass ) == 'used' ? 'disabled' : NULL) . '">Used</a></span></li>';
									echo '<li><span class="no-style"><a href="' . $cert_link . '" title="View Certified Used Inventory" class="list-button ' . (strtolower( $param_saleclass ) == 'used' ? 'disabled' : NULL) . '">Certified</a></span></li>';
									break;
								case 'new':
									echo '<li><span class="no-style"><a href="' . $new_link . '" title="View New Inventory" class="list-button ' . (strtolower( $param_saleclass ) == 'new' ? 'disabled' : NULL) . '">New</a></span></li>';
									break;
				...
				<?php //Make | Model | Trim Fitler
					if ( $trim_count != 0 ) {
						...
						$sidebar_content .= '<li><span class="no-style"><a href="'.$back_link.'" class="armadillo-filter-prev" title="View ' . $param_saleclass . ' Vehicles">&#60; All ' . $param_saleclass . ' Vehicles</a></span></li>';
						$sidebar_content .= '</ul></li></ul>';
