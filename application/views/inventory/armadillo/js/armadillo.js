...
if( jQuery('#armadillo-detail').length ){
	...
	jQuery(document).ready(function(){
		...
		jQuery('#armadillo-friend').click(function() {
		    var fromName = jQuery( "#formtellafriend-from-name" ),
		    toName = jQuery( "#formtellafriend-friend-name" ),
		    fromEmail = jQuery( "#formtellafriend-from-email" ),
		    toEmail = jQuery( "#formtellafriend-friend-email" ),
		    comments = jQuery( "#formtellafriend-comments" ),
		    allFields = jQuery( [] ).add( fromName ).add( toName ).add( fromEmail ).add( toEmail ).add( comments );

		    jQuery('#armadillo-friend-form').dialog({
		        autoOpen: true,
		        height: 500,
		        width: 400,
		        modal: true,
